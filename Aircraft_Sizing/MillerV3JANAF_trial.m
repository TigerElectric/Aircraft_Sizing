function [T2, T4, P4, P62, Pe, MaxPower, Eff, bsfc_bhp] = ...
    MillerV3JANAF_trial(Graph, Diesel, Power, Alt, Boost, xq, Eps, Sigma, Vd, Lean)

%% Depends on Atmos.m

%% Output Controls
plotPV  =   Graph; % Plots PV Diagram of Cycle
Table   =   0; % Plots Table of P,V,T at All States
%% Design Decision
...
% Alt     =   3050;       % Cruise Altitude (10,000 ft = 3050) [m]
% Boost   =   3.5;        % Ratio of Intake to Atm Pressure(Pi/Patm) 1.1254
% 
% xq      =   0;        % Fraction of Heat Input that is ISOCHORIC
...
Vd      =   Vd * .001;   % Displacement volume (Liters*conversion) [m^3]

Plim    =   1.724E7;    % Maximum Pressure (1.034E7 for avgas ; 1.724E7 diesel) [Pa] 
LHV     =   4.354E7;    % Lower Heating Value of Avgas [J/Kg]
Stoich  =   0.0673;      % Avgas/ JetA approximate stoichiometric ratio 1:15
redline =   5500;
